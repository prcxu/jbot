...
from .. import _LogDir, jdbot, chat_id, bot, _JdbotDir, logger, chname
from prettytable import PrettyTable
import subprocess
from .beandata import get_bean_data
from .utils import V4

IN = f'{_LogDir}/bean_income.csv'
OUT = f'{_LogDir}/bean_outlay.csv'
TOTAL = f'{_LogDir}/bean_total.csv'
_botimg = f'{_LogDir}/bean.jpg'
_font = f'{_JdbotDir}/font/jet.ttf'
